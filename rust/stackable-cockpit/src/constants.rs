...
// Currently lots of demos can only run in the default namespace, so we have to keep
// "default" here, until we switch the demos. We cant switch them right now, as the old
// stackablectl would break
