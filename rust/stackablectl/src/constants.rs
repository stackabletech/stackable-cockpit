...
pub const REMOTE_DEMO_BASE_URL: &str =
    "https://raw.githubusercontent.com/stackabletech/demos/refs/heads/";

pub const REMOTE_RELEASE_FILE: &str =
    "https://raw.githubusercontent.com/stackabletech/release/main/releases.yaml";

pub const DEFAULT_COMMITTISH: &str = "d3be4ba"; // release 24.11
