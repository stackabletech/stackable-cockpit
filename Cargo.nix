  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap_complete_nushell" = rec {
        ...
        version = "4.5.9";
        edition = "2021";
        sha256 = "0w0yaacpv20xscirw2c1800iglmr8qlxyd6myz6sl6v977rmj4c1";
        dependencies = [
          {
            name = "clap";
            packageId = "clap";
      ...
      "tower 0.5.2" = rec {
        ...
        resolvedDefaultFeatures = [ "__common" "buffer" "filter" "futures-core" "futures-util" "log" "make" "pin-project-lite" "retry" "sync_wrapper" "timeout" "tokio" "tokio-util" "tracing" "util" ];
      };
