  ...
  internal = rec {
    ...
    crates = {
      ...
      "bcrypt" = rec {
        ...
        version = "0.19.2";
        edition = "2024";
        sha256 = "0lxpcgjnz37jlgxn58427cyz5j30y8w2l8ngg5ffvm2dl9x0cg3z";
        authors = [
      ...
      "blowfish" = rec {
        ...
        version = "0.10.0";
        edition = "2024";
        sha256 = "1652y7y7idaf2gg9agq40pd9xkkka0wfq1xy3cfyfdbvam33kkk2";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "clap_mangen" = rec {
        ...
        version = "0.3.0";
        edition = "2024";
        sha256 = "01qghmfrn9d73hkddq085h22h1y3b84n1n0d16za7xprbfs44a6q";
        dependencies = [
          {
            name = "clap";
            packageId = "clap";
      ...
      "comfy-table" = rec {
        ...
        resolvedDefaultFeatures = [ "custom_styling" "default" "tty" ];
      };
      ...
      "hyper-rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "aws-lc-rs" "http1" "log" "logging" "native-tokio" "ring" "rustls-native-certs" "tls12" ];
      };
      "hyper-timeout" = rec {
      ...
      "kube" = rec {
        ...
        resolvedDefaultFeatures = [ "admission" "client" "config" "derive" "http-proxy" "jsonpatch" "kube-client" "kube-derive" "kube-runtime" "ring" "runtime" "rustls-tls" "socks5" "ws" ];
      };
      "kube-client" = rec {
        ...
        resolvedDefaultFeatures = [ "__non_core" "base64" "bytes" "client" "config" "either" "futures" "http-body" "http-body-util" "http-proxy" "hyper" "hyper-rustls" "hyper-timeout" "hyper-util" "jiff" "jsonpatch" "jsonpath-rust" "pem" "ring" "rustls" "rustls-tls" "serde-saphyr" "socks5" "tokio" "tokio-tungstenite" "tokio-util" "tower" "tower-http" "tracing" "ws" ];
      };
      "kube-core" = rec {
        crateName = "kube-core";
        version = "4.2.0";
        ...
        resolvedDefaultFeatures = [ "admission" "json-patch" "jsonpatch" "schema" "schemars" "ws" ];
      };
      "kube-derive" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "json" "rustls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.14";
      ...
      "roff" = rec {
        ...
        version = "1.1.1";
        edition = "2024";
        sha256 = "12c1pibjxdjai80hpalxgqkzn30316x49iry4rdscrcn3mz42g1j";
      ...
      "snafu 0.9.2" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "futures" "rust_1_81" "std" ];
      };
      ...
      "stackable-cockpit" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            features = [ "crds" "kube-ws" "kube-http-proxy" "kube-socks5" ];
          }
          {
            name = "tera";
            packageId = "tera";
      ...
      "stackable-operator" = rec {
        ...
        resolvedDefaultFeatures = [ "crds" "kube-http-proxy" "kube-socks5" "kube-ws" ];
      };
      ...
      "tera" = rec {
        ...
        version = "2.0.0";
        edition = "2024";
        sha256 = "0k02z3z2mx7pl7iyd1nqdfcakvd99wkzl7z1c815f6vpb2yn5siq";
        dependencies = [
          {
            name = "serde";
            packageId = "serde";
      ...
      "tokio-rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "aws-lc-rs" "aws_lc_rs" "logging" "tls12" ];
      };
      "tokio-stream" = rec {
      ...
      "utoipa" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "indexmap" "macros" ];
      };
      "utoipa-gen" = rec {
